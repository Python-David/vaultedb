...
class ProtectedMetaDict(dict):
    """
    A dictionary subclass that protects core VaultDB metadata fields from being overwritten.
...
class DocumentStorage:
    ...
    def _load(self, app_name: Optional[str]):
        ...
        try:
            ...
            raise StorageError(
                "VaultDB failed to load this file — it is not valid JSON and may be corrupted or tampered with.") from e
